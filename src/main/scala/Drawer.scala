...
class ResourceImageDrawer(val id : Int) extends Drawer
{
    ...
    def apply(gl : GL10) : Unit =
    {
        ...
        val vertex = Array(0, 0, w, 0, w, h, 0, h)
        ...
        val tvertex = Array(0, th, tw, th, tw, 0, 0, 0)
        ...
        val invscalex = (0x10000.toDouble / scale).toInt
        ...
        gl.glScalex(invscalex, invscalex, 0x10000)
...
class ImageDrawer(val img : Bitmap) extends Drawer
{
    ...
    def apply(gl : GL10) : Unit =
    {
        ...
        val vertex = Array(0, 0, w, 0, w, h, 0, h)
        val tvertex = Array(0, 0, x, 0, x, x, 0, x)
